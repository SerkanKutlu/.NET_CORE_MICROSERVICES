...
public class OrderController : ControllerBase
{
    ...
    #region Get Requests
        ...
        public async Task<IActionResult> GetOrdersPagedA([FromQuery] RequestParameters requestParameters)
        {
            var orders = await _orderRequestService.GetOrdersPaged(requestParameters,HttpContext);
            return Ok("x");
        }
